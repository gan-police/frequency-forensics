...
#SBATCH --job-name=lsun_log_db4_boundary
#SBATCH --output=prepare_dataset_lsun_log_db4_boundary-%j.out
#SBATCH --error=prepare_dataset_lsun_log_db4_boundary-%j.err
#SBATCH -p gpu
