...
#SBATCH --job-name=celebA_log_sym4_boundary
#SBATCH --output=prepare_dataset_celebA_log_sym4_boundary-%j.out
#SBATCH --error=prepare_dataset_celebA_log_sym4_boundary-%j.err
#SBATCH -p gpu
